...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1><i class="fas fa-building nav-icon mr-1"></i> Data Cabang</h1>
      </div>
      <div class="col-sm-6">
                ...
                <?php foreach ($cabang as $data) : ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="index.php?halaman=edit_dt_cabang&id=<?= $data['ID_cabang']; ?>" class="btn btn-dark btn-sm"><i class="fas fa-edit"></i> Edit</a>
                      <a href="fungsi_delete/delete_dt_cabang.php?id=<?= $data['ID_cabang']; ?>" class="btn btn-dark btn-sm" onclick="return confirm('Anda yakin ingin menghapusnya?');"><i class="fas fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
